        ...
        <div class="mx-auto space-y-6 max-w-7xl sm:px-6 lg:px-8">
            <div class="p-4 bg-white shadow-sm sm:p-8 sm:rounded-lg">
                <div class="w-full grid grid-cols-1 md:grid-cols-2 gap-12">
                    ...
                    <form class="mt-6" action="{{ route('dokter.janji-periksa.store', $janjiPeriksa->id) }}"
                        method="POST">
                        @csrf
                        ...
                        <div class="mb-3 form-group">
                            ...
                            <input type="date" class="rounded form-control" id="tgl_periksa" name="tgl_periksa"
                                value="{{ old('tgl_periksa', now()->format('Y-m-d')) }}">
                        </div>

                        <div class="mb-3 form-group">
                            <label for="catatan">Catatan</label>
                            <textarea type="text" class="rounded form-control" id="catatan" name="catatan" value="{{ old('catatan') }}"></textarea>
                        </div>
